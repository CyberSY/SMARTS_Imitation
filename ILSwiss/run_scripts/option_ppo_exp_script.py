...
from rlkit.torch.algorithms.option.policies import OptionTanhPolicy
...
def experiment(variant):
    ...
    for agent_id in env.agent_ids:
        ...
        if policy_id not in policy_trainer_n:
            ...
            share_option_nets = variant.get("share_option_nets", True)
            if share_option_nets:
                print("Using a shared option net ...")
            else:
                print("Using separated option nets ...")
            vf = FlattenMlp(
